...
//! in `sebas-router/src/models.rs`, and patch the existing file's
...
/// Result of patching `sebas-router/src/models.rs`.
pub struct PatchReport {
    pub entries_written: usize,
    pub timestamp_line: String,
}

/// Patch `sebas-router/src/models.rs` in place: update the
...
mod tests {
    ...
    /// matches what `sebas-router/src/models.rs` expects. This is the
